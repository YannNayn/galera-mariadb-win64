...
{ "ER_PASSWORD_ANONYMOUS_USER", 1131, "You are using MariaDB as an anonymous user and anonymous users are not allowed to change passwords" },
...
{ "ER_TABLEACCESS_DENIED_ERROR", 1142, "%-.16s command denied to user \'%s\'@\'%s\' for table \'%-.192s\'" },
{ "ER_COLUMNACCESS_DENIED_ERROR", 1143, "%-.16s command denied to user \'%s\'@\'%s\' for column \'%-.192s\' in table \'%-.192s\'" },
...
{ "ER_MASTER_INFO", 1201, "Could not initialize master info structure; more error messages can be found in the MariaDB error log" },
...
{ "ER_PROCACCESS_DENIED_ERROR", 1370, "%-.16s command denied to user \'%s\'@\'%s\' for routine \'%-.192s\'" },
...
{ "ER_TOO_BIG_SCALE", 1425, "Too big scale %u specified for \'%-.192s\'. Maximum is %lu." },
{ "ER_TOO_BIG_PRECISION", 1426, "Too big precision %u specified for \'%-.192s\'. Maximum is %lu." },
...
{ "ER_LAST_MYSQL_ERROR_MESSAGE", 1728, "\"" },
...
{ "ER_WARNING_NON_DEFAULT_VALUE_FOR_VIRTUAL_COLUMN", 1906, "The value specified for computed column \'%s\' in table \'%s\' ignored" },
...
{ "ER_NETWORK_READ_EVENT_CHECKSUM_FAILURE", 1913, "Replication event checksum verification failed while reading from network." },
{ "ER_BINLOG_READ_EVENT_CHECKSUM_FAILURE", 1914, "Replication event checksum verification failed while reading from a log file." },
{ "ER_CANT_DO_ONLINE", 1915, "Can\'t execute the given \'%s\' command as online" },
...
{ "ER_INTERNAL_ERROR", 1928, "Internal error: \'%-.192s\'" },
