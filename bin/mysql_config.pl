...
my $ldata   = 'C:/MariaDB5.5/data';
my $execdir = 'C:/temporary/mariadb-galera/inst_temp/Win64/bin';
my $bindir  = 'C:/temporary/mariadb-galera/inst_temp/Win64/bin';

# ----------------------------------------------------------------------
# If installed, search for the compiled in directory first (might be "lib64")
# ----------------------------------------------------------------------

my $pkglibdir = fix_path('C:/temporary/mariadb-galera/inst_temp/Win64/lib',"libmysql/relwithdebinfo",
                         "libmysql/release","libmysql/debug","lib/mysql","lib");

my $pkgincludedir = fix_path('C:/temporary/mariadb-galera/inst_temp/Win64/include/mysql', "include/mysql", "include");
...
my $flags;
$flags->{libs} =
  [@ldflags,@lib_opts,'','ws2_32 z IPHLPAPI mysys_ssl w:/PBA/SE/win64/libs/ssleay32.lib w:/PBA/SE/win64/libs/libeay32.lib C:/temporary/mariadb-galera/temp_libs/Win64/libs/crypto.lib ','',''];
$flags->{libs_r} =
  [@ldflags,@lib_r_opts,'','',''];
$flags->{embedded_libs} =
  [@ldflags,@lib_e_opts,'','','','',''];
...
$flags->{cflags}  = [@{$flags->{include}},split(" ",' /DWIN32 /D_WINDOWS /W3 /MP /wd4800 /wd4805 /wd4996 -DWITH_WSREP -DWSREP_PROC_INFO -DMYSQL_MAX_VARIABLE_VALUE_LEN=2048 -DWITH_INNODB_DISALLOW_WRITES /MD /Zi /Od  /D NDEBUG -DDBUG_OFF')];
