...
$opt_help          = 0;
$opt_log           = undef();
$opt_mysqladmin    = "C:/temporary/mariadb-galera/inst_temp/Win64/bin/mysqladmin";
$opt_mysqld        = "C:/temporary/mariadb-galera/inst_temp/Win64/bin/mysqld";
$opt_no_log        = 0;
$opt_password      = undef();
$opt_tcp_ip        = 0;
$opt_user          = "root";
...
#### order:  my_print_defaults mysqld datadir, C:/temporary/mariadb-galera/inst_temp/Win64/share
####
...
sub init_log
{
  ...
  if (!defined($logdir))
  {
    $logdir= "C:/temporary/mariadb-galera/inst_temp/Win64/share" if (-d "C:/temporary/mariadb-galera/inst_temp/Win64/share" && -w "C:/temporary/mariadb-galera/inst_temp/Win64/share");
  }
  if (!defined($logdir))
  {
...
sub list_defaults_files
{
  ...
  return grep { defined $_ and not $seen{$_}++ and -f $_ and -r $_ }
              ('/etc/my.cnf',
               '/etc/mysql/my.cnf',
               'C:/temporary/mariadb-galera/inst_temp/Win64/my.cnf',
...
#
#   Before using, you must create a my.cnf file either in C:/temporary/mariadb-galera/inst_temp/Win64/my.cnf
...
[mysqld_multi]
mysqld     = C:/temporary/mariadb-galera/inst_temp/Win64/bin/mysqld_safe
mysqladmin = C:/temporary/mariadb-galera/inst_temp/Win64/bin/mysqladmin
user       = multi_admin
...
port       = 3307
pid-file   = C:/MariaDB5.5/data2/hostname.pid2
datadir    = C:/MariaDB5.5/data2
language   = C:/temporary/mariadb-galera/inst_temp/Win64/share/mysql/english
user       = unix_user1
...
port       = 3308
pid-file   = C:/MariaDB5.5/data3/hostname.pid3
datadir    = C:/MariaDB5.5/data3
language   = C:/temporary/mariadb-galera/inst_temp/Win64/share/mysql/swedish
user       = unix_user2

[mysqld4]
socket     = /tmp/mysql.sock4
port       = 3309
pid-file   = C:/MariaDB5.5/data4/hostname.pid4
datadir    = C:/MariaDB5.5/data4
language   = C:/temporary/mariadb-galera/inst_temp/Win64/share/mysql/estonia
user       = unix_user3
 
[mysqld6]
socket     = /tmp/mysql.sock6
port       = 3311
pid-file   = C:/MariaDB5.5/data6/hostname.pid6
datadir    = C:/MariaDB5.5/data6
language   = C:/temporary/mariadb-galera/inst_temp/Win64/share/mysql/japanese
user       = unix_user4
EOF
  exit(0);
}
